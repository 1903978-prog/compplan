...
export default function Dashboard() {
  ...
  const exportXLS = () => {
    ...
    const xml = `<?xml version="1.0"?>\n<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet"><Worksheet ss:Name="Eendigo Command Center"><Table>${xmlRows}</Table></Worksheet></Workbook>`;
