...
const DEFAULT_ROLE_GRID = [
  ...
  { role_code: "EM1", role_name: "Engagement Manager 1", next_role_code: "EM2", promo_years_fast: 1, promo_years_normal: 1.5, promo_years_slow: 2, ral_min_k: 58, ral_max_k: 73, gross_fixed_min_month: 3803, gross_fixed_max_month: 4563, bonus_pct: 20, meal_voucher_eur_per_day: 8, months_paid: 13, sort_order: 8 },
  { role_code: "EM2", role_name: "Engagement Manager 2", next_role_code: null, promo_years_fast: 1, promo_years_normal: 1.5, promo_years_slow: 2, ral_min_k: 73, ral_max_k: 90, gross_fixed_min_month: 4563, gross_fixed_max_month: 5476, bonus_pct: 25, meal_voucher_eur_per_day: 8, months_paid: 13, sort_order: 9 },
];
